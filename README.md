...
**What is not frozen:** the RFC text. All thirteen RFCs are drafts — eight at `**Version:** 1.0.0-draft`, RFC-MACP-0002 and RFC-MACP-0011 at `1.1.0-draft`, RFC-MACP-0007 and RFC-MACP-0012 at `1.2.0-draft`, and RFC-MACP-0006 at `1.4.0-draft`. Nothing in this repository has been declared wire-frozen, and normative wording can still change.
